...
you should place your code here."
  ...
  (setq org-home-file (concat org-home-directory "home.org"))
  (setq org-default-notes-file (concat org-home-directory "tasks.org"))
  (define-key evil-normal-state-map (kbd "SPC o o")
    (lambda () (interactive) (find-file org-home-file)))
  (define-key evil-normal-state-map (kbd "SPC o t")
    (lambda () (interactive) (find-file org-default-notes-file)))

  ;; Org capture templates and configuration.
  ...
  ;; Org mobile configuartion.
  (setq org-mobile-directory (concat org-directory "MobileOrg")
        org-mobile-inbox-for-pull (concat org-directory "mobileorg-inbox.org")
        )
